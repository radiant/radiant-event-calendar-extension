...
},sum:function(){var a=0,b=this.length;if(b){do{a+=this[--b];}while(b);}return a;},unique:function(){return[].combine(this);}});String.implement({parseQueryString:function(){var b=this.split(/[&;]/),a={};
...
this.get("spinner",a.options).hide(a.callback);return this;}});